...
var uPortID = function () {
  function uPortID(_identifier) {
    var _ref = arguments.length <= 1 || arguments[1] === undefined ? _utils.defaults : arguments[1];

    var apiHost = _ref.apiHost;
    var apiPort = _ref.apiPort;
    var apiPath = _ref.apiPath;

    _classCallCheck(this, uPortID);

    this._api = new _api2.default(_identifier, { apiHost: apiHost, apiPort: apiPort, apiPath: apiPath });
